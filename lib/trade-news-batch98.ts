...
export const TRADE_NEWS_BATCH_98: BlogPost[] = [
  {
    slug: "inventory-carrying-cost-batch-98-01",
  ...
  {
    slug: "reverse-logistics-returns-batch-98-02",
  ...
  {
    slug: "freight-audit-payment-batch-98-03",
  ...
  {
    slug: "cross-border-ecommerce-logistics-batch-98-04",
  ...
  {
    slug: "sustainable-supply-chain-batch-98-05",
  ...
  {
    slug: "trade-lane-risk-assessment-batch-98-06",
  ...
  {
    slug: "multimodal-transport-optimization-batch-98-07",
  ...
  {
    slug: "customs-brokerage-management-batch-98-08",
  ...
  {
    slug: "supplier-financial-health-batch-98-09",
  ...
  {
    slug: "inventory-visibility-supply-chain-batch-98-10",
