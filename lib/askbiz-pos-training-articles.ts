...

  {
    ...
    content: [
      ...
      },
      {
        ...
        body: "Repair mode is designed for phone repair shops, electronics services, and trade businesses — it includes job management, customer quotes, and parts inventory. Salon mode adds appointment booking, staff scheduling, and service menus. Factory mode is built around production runs rather than individual retail sales, with nine dedicated pages — Capture, Batch, Quality, Downtime, Shift, Waybill, Production, Staff, and Approvals — that track a batch from raw material intake through to dispatch. Camera capture is split into intake, output, wastage, and dispatch stages, each gated behind its own permission, and five factory-specific staff roles (line operator, quality inspector, shift supervisor, production manager, inventory manager) replace the generic cashier roles used elsewhere. If you set your business type to 'manufacturer', a factory-type picker offers 12 pre-built templates — oil pressing, water, milling, dairy, bakery, soap, and more — that pre-fill stage guidance and expected yield ranges for your specific process. Logistics mode centres on parcel management, driver assignment, and route planning. If your business spans multiple modes — for example a salon that also sells retail hair products — use Retail for the product sales and Salon for services."
      }
    ],
    relatedSlugs: ["pos-inventory-management-askbiz", "pos-sales-transactions-askbiz", "pos-reports-askbiz", "factory-sector-guide-askbiz"],
    faq: [
