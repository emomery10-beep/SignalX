...
export const TRADE_NEWS_BATCH_4: BlogPost[] = [
  {
    slug: "inventory-carrying-cost-batch-4-01",
  ...
  {
    slug: "reverse-logistics-returns-batch-4-02",
  ...
  {
    slug: "freight-audit-payment-batch-4-03",
  ...
  {
    slug: "cross-border-ecommerce-logistics-batch-4-04",
  ...
  {
    slug: "sustainable-supply-chain-batch-4-05",
  ...
  {
    slug: "trade-lane-risk-assessment-batch-4-06",
  ...
  {
    slug: "multimodal-transport-optimization-batch-4-07",
  ...
  {
    slug: "customs-brokerage-management-batch-4-08",
  ...
  {
    slug: "supplier-financial-health-batch-4-09",
  ...
  {
    slug: "inventory-visibility-supply-chain-batch-4-10",
