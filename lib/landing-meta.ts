...
// ── SEO Metadata ─────────────────────────────────────────────────────────────
// Each locale variant self-canonicalizes to its own URL and carries the full
...
export const META_BY_LOCALE: Record<string, { title: string; description: string }> = {
  en: {
...
export function buildLandingMetadata(locale: string): Metadata {
...
export const PRICING_TIERS: Record<string, { growth: string; business: string; sym: string; pos: string }> = {
...
export function buildLandingSchemas(): Record<string, unknown>[] {
  return [
