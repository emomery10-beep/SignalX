...
export const PLAN_DESCRIPTIONS: Record<PlanId, string> = {
  free:     '10 free questions per month. Upload your data, get your Business Pulse score with a live KPI strip, and explore all tools — no card needed.',
  growth:   'Unlimited questions, unlimited source connections, Daily Brief, anomaly alerts, revenue & margin waterfall, social commerce, churn intelligence, and market intelligence.',
  business: 'Everything in Growth plus Decision Timeline, CFO Mode with 6 board-ready report types, team seats, Competitor Watch, and priority support.',
}

export const PLAN_HIGHLIGHTS: Record<PlanId, string[]> = {
  free: [
    '10 questions per month',
    'Business Pulse score + Command Centre KPI strip',
    'Upload CSV & Excel files',
    'Connect up to 3 data sources',
    'FX Risk, Landed Cost & Export Tools (manual input)',
    'Supplier Scorecard (view only)',
    'API access included',
    'No credit card required',
  ],
  growth: [
    'Unlimited questions',
    'Unlimited data source connections (30+ integrations)',
    'Daily Brief — AI-generated morning intelligence',
    'Anomaly alerts + revenue & margin waterfall chart',
    'All tools pre-filled from your connected data',
    'Social Commerce — TikTok, Instagram, Pinterest',
    'Churn Intelligence — monthly at-risk customer scan',
    'Export Market Scoring — 20 markets + product match',
    'Market intelligence — live prices & web signals',
  ],
  business: [
    'Everything in Growth',
    'Decision Timeline — visual 6-week outcome tracker',
    'CFO Mode — P&L, cash runway & board reports (6 types)',
    'Team seats — up to 5 members with role-based access',
    'Competitor Watch — live price monitoring',
