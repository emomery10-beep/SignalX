...
export const TRADE_NEWS_BATCH_54: BlogPost[] = [
  {
    slug: "inventory-carrying-cost-batch-54-01",
  ...
  {
    slug: "reverse-logistics-returns-batch-54-02",
  ...
  {
    slug: "freight-audit-payment-batch-54-03",
  ...
  {
    slug: "cross-border-ecommerce-logistics-batch-54-04",
  ...
  {
    slug: "sustainable-supply-chain-batch-54-05",
  ...
  {
    slug: "trade-lane-risk-assessment-batch-54-06",
  ...
  {
    slug: "multimodal-transport-optimization-batch-54-07",
  ...
  {
    slug: "customs-brokerage-management-batch-54-08",
  ...
  {
    slug: "supplier-financial-health-batch-54-09",
  ...
  {
    slug: "inventory-visibility-supply-chain-batch-54-10",
