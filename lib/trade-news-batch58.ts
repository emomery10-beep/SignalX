...
export const TRADE_NEWS_BATCH_58: BlogPost[] = [
  {
    slug: "inventory-carrying-cost-batch-58-01",
  ...
  {
    slug: "reverse-logistics-returns-batch-58-02",
  ...
  {
    slug: "freight-audit-payment-batch-58-03",
  ...
  {
    slug: "cross-border-ecommerce-logistics-batch-58-04",
  ...
  {
    slug: "sustainable-supply-chain-batch-58-05",
  ...
  {
    slug: "trade-lane-risk-assessment-batch-58-06",
  ...
  {
    slug: "multimodal-transport-optimization-batch-58-07",
  ...
  {
    slug: "customs-brokerage-management-batch-58-08",
  ...
  {
    slug: "supplier-financial-health-batch-58-09",
  ...
  {
    slug: "inventory-visibility-supply-chain-batch-58-10",
