...
export const waveB2Translations: Record<string, AcademyTranslation> = {
  "what-is-enterprise-value": {
    ...
    "content": [
      ...
      },
      {
        ...
        "body": "When evaluating acquisition targets, buyers focus on enterprise value to understand the true cost of ownership. A company may appear cheap based on its share price but carry significant hidden debt. Conversely, a company with large cash reserves effectively costs less than its market cap suggests. Understanding EV is essential for anyone involved in M&A, whether analysing deals on the Johannesburg kayd Exchange or evaluating private companies across Africa."
      }
    ],
    "keyTakeaways": [
  ...
  "what-is-discounted-cash-flow": {
    ...
    "content": [
      ...
      },
      {
        ...
        "body": "A DCF model starts with detailed financial projections, typically five to ten years of dakhli, expenses, and capital expenditures to derive free cash flow. The discount rate, usually the weighted average cost of capital (WACC), reflects the blended cost of the company's debt and equity financing. A terminal value is calculated to capture value beyond the forecast period, often using a perpetuity growth method or exit multiple approach."
      },
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "DCF is challenging for early-stage startups because their cash flows are difficult to predict and often negative. Alternative methods like comparable company analysis or venture capital valuation methods are more commonly used for startups until they reach stable, predictable dakhli."
      }
    ]
  },
  "what-is-a-comparable-company-analysis": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "The most common multiples are EV/EBITDA and EV/dakhli for enterprise-level comparisons, and price-to-earnings for equity-level analysis. The choice depends on the industry and the target's profitability stage. Unprofitable companies often use dakhli-based multiples."
      },
      {
  ...
  "what-is-price-to-earnings-ratio": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "When a company has negative earnings, dividing the share price by a negative number produces a meaningless negative ratio. For unprofitable companies, analysts use alternative multiples like price-to-sales, price-to-book, or EV/dakhli to assess relative valuation."
      },
      {
  ...
  "what-is-a-hurdle-rate": {
    ...
    "content": [
      {
        ...
        "body": "A hurdle rate is the minimum rate of return that a fund must deliver to its investors before the fund maareeye, or general partner, begins earning performance-based compensation known as carried interest. It serves as a protective mechanism for limited partners, ensuring that fund managers are only rewarded for generating returns above a meaningful threshold. The concept is central to the economics of private equity, venture capital, and hedge fund structures."
      },
      {
    ...
    "keyTakeaways": [
      "A hurdle rate is the minimum return that must be achieved before a fund maareeye earns carried interest.",
      "It aligns maareeye incentives with investor interests by ensuring a baseline return before faa'iido sharing.",
  ...
  "what-is-safety-stock": {
    "title": "What Is Safety kayd?",
    "description": "Learn how safety kayd acts as a buffer inventory to protect against demand variability and supply disruptions, preventing costly stockouts.",
    "keywords": [
      "safety kayd",
      "buffer inventory",
      "stockout prevention",
    ...
    "content": [
      {
        "heading": "What Safety kayd Is",
        "body": "Safety kayd is the additional inventory a business holds beyond its expected demand to protect against uncertainty. Demand can surge unexpectedly, suppliers can deliver late, and production can face delays. Without safety kayd, any of these events leads to a stockout, resulting in lost sales, damaged customer relationships, and potential production shutdowns. Safety kayd serves as an insurance policy against the inherent unpredictability of supply chains."
      },
      {
        "heading": "How to Calculate Safety kayd",
        "body": "The most common formula multiplies the desired service factor (from a standard normal distribution table) by the standard deviation of demand during lead time. A simpler approach uses: Safety kayd = (Maximum Daily Usage x Maximum Lead Time) minus (Average Daily Usage x Average Lead Time). The calculation requires reliable historical data on demand patterns and supplier performance. Businesses with seasonal demand or long international supply chains, common in African markets, typically need higher safety kayd levels."
      },
      {
        "heading": "Factors That Influence Safety kayd Levels",
        "body": "Several factors determine how much safety kayd a business should hold. Higher demand variability requires more buffer. Longer and less predictable lead times also increase the need. The desired service level, the probability of not experiencing a stockout, directly affects the calculation. Product criticality matters too: a manufacturer might hold more safety kayd for components that would halt an entire production line than for items that are easily substitutable."
      },
      {
        "heading": "Balancing Costs and Service",
        "body": "Holding too much safety kayd ties up working capital and increases storage costs, while holding too little risks stockouts and lost dakhli. The optimal balance depends on carrying costs, stockout costs, and the company's service level targets. Businesses operating in markets with unreliable logistics infrastructure, such as those relying on imports through congested ports like Lagos or Mombasa, often maintain higher safety kayd to compensate for supply chain unpredictability."
      }
    ],
    "keyTakeaways": [
      "Safety kayd is extra inventory held to guard against unexpected demand spikes or supply delays.",
      "The optimal level balances the cost of holding additional inventory against the cost of stockouts.",
      "Calculating safety kayd requires data on demand variability, lead time variability, and desired service level."
    ],
    "faq": [
      {
        "q": "What is the difference between safety kayd and buffer kayd?",
        "a": "The terms are often used interchangeably. However, some practitioners distinguish safety kayd as protection against demand uncertainty specifically, while buffer kayd refers more broadly to any extra inventory held to absorb variability in either demand or supply processes."
      },
      {
        "q": "How often should safety kayd levels be reviewed?",
        "a": "Safety kayd should be reviewed at least quarterly, or whenever significant changes occur in demand patterns, supplier reliability, or lead times. Seasonal businesses should adjust safety kayd levels ahead of peak periods to maintain service levels during high-demand windows."
      },
      {
        "q": "Can a business have zero safety kayd?",
        "a": "Theoretically, yes, if demand is perfectly predictable and supply is completely reliable. In practice, most businesses carry some safety kayd. Just-in-time systems minimise safety kayd but require extremely reliable suppliers and short, consistent lead times to function effectively."
      }
    ]
  },
  "what-is-reorder-point": {
    "title": "What Is Reorder Point?",
    "description": "Understand how the reorder point determines exactly when to place a new order so that inventory arrives before kayd runs out.",
    "keywords": [
      "reorder point",
    ...
    "content": [
      {
        ...
        "body": "The reorder point (ROP) is the specific inventory quantity that triggers a new replenishment order. When kayd on hand falls to this level, it signals that enough inventory remains to cover demand during the lead time required for the new order to arrive. Setting the reorder point correctly ensures continuous product availability without ordering too early, which would inflate inventory carrying costs unnecessarily."
      },
      {
        "heading": "How to Calculate the Reorder Point",
        "body": "The standard formula is: Reorder Point = (Average Daily Demand x Lead Time in Days) + Safety kayd. For example, if a retailer sells 50 units per day with a 10-day lead time and maintains 200 units of safety kayd, the reorder point is 700 units. When inventory drops to 700, a new order is placed, and the safety kayd covers any variability during the replenishment period."
      },
      {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. Reorder points should be updated as demand patterns, lead times, and safety kayd requirements change. Seasonal demand shifts, new supplier arrangements, or changes in logistics infrastructure all warrant recalculating the reorder point."
      },
      {
  ...
  "what-is-economic-order-quantity": {
    ...
    "keyTakeaways": [
      ...
      "The formula balances the fixed cost per order against the cost of holding each unit in kayd.",
  ...
  "what-is-vendor-managed-inventory": {
    ...
    "description": "Learn how vendor-managed inventory shifts replenishment responsibility to the supplier, improving kayd availability and reducing buyer workload.",
    "keywords": [
    ...
    "content": [
      ...
      },
      {
        ...
        "body": "VMI requires significant trust between parties and robust data-sharing infrastructure. Suppliers must invest in monitoring systems and logistics capabilities. Disagreements over optimal kayd levels, liability for excess inventory, and data accuracy can create friction. Smaller suppliers may lack the resources to manage VMI effectively. Clear contractual terms covering kayd ownership, obsolescence risk, and performance penalties are essential to making VMI work in practice."
      }
    ],
    "keyTakeaways": [
  ...
  "what-is-consignment-inventory": {
    ...
    "description": "Understand how consignment inventory allows a retailer to kayd goods owned by the supplier, paying only when items are sold to the end customer.",
    "keywords": [
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "In consignment, ownership never transfers until the final sale. In sale-or-return, ownership transfers to the retailer upon delivery but the retailer can return unsold goods for a celin lacag within an agreed period. The accounting and risk treatment differ between the two models."
      },
      {
        "q": "What happens to damaged consignment kayd?",
  ...
  "what-is-just-in-time-inventory": {
    ...
    "content": [
      ...
      },
      {
        ...
        "body": "JIT dramatically reduces inventory carrying costs, frees up warehouse space, and improves cash flow by minimising capital tied up in kayd. It also exposes quality problems quickly since there is no buffer inventory to mask defects. Companies using JIT often see reduced waste, faster throughput, and improved product quality. The discipline required to maintain JIT systems drives continuous improvement in processes, supplier relationships, and production efficiency."
      },
      {
    ...
    "faq": [
      {
        ...
        "a": "The main risk is vulnerability to supply chain disruptions. With minimal buffer kayd, any delay from a supplier, shipping disruption, or sudden demand spike can halt production. The COVID-19 pandemic exposed this vulnerability when many JIT-dependent manufacturers faced critical shortages."
      },
      {
      ...
      {
        "q": "How does JIT differ from holding safety kayd?",
        "a": "JIT minimises all inventory including safety kayd, relying instead on supply chain reliability and speed. Safety kayd is essentially the opposite approach: holding extra inventory to absorb uncertainty. Many businesses use a hybrid approach, applying JIT principles where feasible while maintaining safety kayd for critical or hard-to-source items."
      }
    ]
  },
  "what-is-buffer-stock": {
    "title": "What Is Buffer kayd?",
    "description": "Learn how buffer kayd protects operations from variability in supply and demand by maintaining strategic inventory reserves at key points in the supply chain.",
    "keywords": [
      "buffer kayd",
      "inventory buffer",
    ...
    "content": [
      {
        "heading": "What Buffer kayd Is",
        "body": "Buffer kayd is additional inventory maintained at various points in the supply chain to absorb fluctuations in supply, demand, or production. It acts as a shock absorber, ensuring that variability in one part of the chain does not cascade into shortages elsewhere. While similar to safety kayd, buffer kayd is a broader concept that applies throughout the supply chain, not just at the finished goods level. Manufacturers, distributors, and retailers all use buffer kayd strategies."
      },
      {
        "heading": "Where Buffer kayd Is Positioned",
        "body": "Buffer kayd can be placed at multiple points: raw materials inventory buffers protect against supplier delays, work-in-process buffers prevent production bottlenecks, and finished goods buffers ensure product availability for customers. Strategic positioning depends on where the greatest variability exists. A manufacturer importing components through Mombasa port might hold larger raw material buffers to account for shipping and customs variability, while maintaining smaller finished goods buffers."
      },
      {
        "heading": "Determining Buffer kayd Levels",
        "body": "Optimal buffer kayd levels depend on the degree of variability in the supply chain, the cost of holding inventory versus the cost of disruption, and the lead time for replenishment. Statistical methods analyse historical data to quantify variability and set appropriate levels. Industries with perishable goods or rapid obsolescence, like food and electronics, must balance buffer kayd against spoilage and depreciation risk, keeping levels as lean as practical."
      },
      {
        "heading": "Buffer kayd in Government Policy",
    ...
    "keyTakeaways": [
      "Buffer kayd is inventory held at strategic points to absorb variability in supply or demand.",
      "It protects against production delays, shipping disruptions, and unexpected demand surges.",
      "The cost of carrying buffer kayd must be weighed against the cost of operational disruptions."
    ],
    "faq": [
      {
        "q": "Is buffer kayd the same as safety kayd?",
        "a": "The terms overlap significantly. Safety kayd specifically refers to extra inventory held to protect against demand uncertainty at the finished goods level. Buffer kayd is a broader concept encompassing extra inventory held anywhere in the supply chain to absorb any type of variability."
      },
      {
        "q": "How does buffer kayd affect working capital?",
        "a": "Buffer kayd ties up working capital that could otherwise be used for operations or investments. The financial impact depends on the value and volume of inventory held. Businesses must balance the working capital cost against the potential losses from disruptions that buffer kayd prevents."
      },
      {
        "q": "Can too much buffer kayd be harmful?",
        "a": "Yes. Excessive buffer kayd increases carrying costs, warehouse requirements, and the risk of obsolescence or spoilage. It can also mask underlying supply chain problems that should be resolved. Regular review ensures buffer levels remain appropriate for current conditions."
      }
    ]
  },
  "what-is-stock-turnover-ratio": {
    "title": "What Is kayd Turnover Ratio?",
    "description": "Understand how the kayd turnover ratio measures how efficiently a business sells and replaces its inventory over a given period.",
    "keywords": [
      "kayd turnover ratio",
      "inventory turnover",
    ...
    "content": [
      {
        "heading": "What the kayd Turnover Ratio Measures",
        "body": "The kayd turnover ratio, also called inventory turnover, measures how frequently a company sells through its entire inventory during a specific period, typically a year. It indicates how efficiently a business converts inventory into sales. A higher turnover means inventory moves quickly, suggesting strong demand and effective kayd management. A lower turnover may indicate overstocking, weak sales, or obsolete inventory sitting on shelves."
      },
      {
        "heading": "How to Calculate kayd Turnover",
        "body": "The formula is: kayd Turnover Ratio = Cost of Goods Sold / Average Inventory. Average inventory is calculated as (Beginning Inventory + Ending Inventory) / 2. For example, if a business has annual COGS of $500,000 and average inventory of $100,000, the turnover ratio is 5, meaning it sells through its inventory five times per year, or roughly every 73 days."
      },
      {
      ...
      {
        "heading": "Improving kayd Turnover",
        "body": "Businesses can improve turnover by better matching purchases to demand through forecasting, reducing lead times with local sourcing, implementing clearance strategies for slow-moving kayd, and optimising product assortment. Demand planning tools and point-of-sale data analytics help identify trends early. However, pursuing extremely high turnover can backfire if it leads to frequent stockouts that drive customers to competitors."
      }
    ],
    "keyTakeaways": [
      "kayd turnover ratio measures how many times inventory is sold and replaced during a period.",
    ...
    "faq": [
      {
        "q": "What does a low kayd turnover ratio indicate?",
      ...
      {
        "q": "Can kayd turnover be too high?",
    ...
    "content": [
      {
        ...
        "body": "Days sales of inventory calculates the average number of days a company holds inventory before selling it. It translates the kayd turnover ratio into a time-based metric that is intuitive and easy to communicate. A DSI of 30 means the company, on average, sells its entire inventory every 30 days. This metric helps managers, investors, and lenders assess how efficiently a business manages its kayd and how quickly it can convert inventory into cash."
      },
      {
        "heading": "How to Calculate DSI",
        "body": "The formula is: DSI = (Average Inventory / Cost of Goods Sold) x 365 days. Alternatively, DSI = 365 / Inventory Turnover Ratio. For example, if average inventory is $200,000 and annual COGS is $1,200,000, DSI equals approximately 61 days. This means the business takes about two months on average to sell through its kayd. The calculation can be adapted for quarterly or monthly periods by adjusting the number of days accordingly."
      },
      {
      ...
      },
      {
        ...
        "body": "DSI varies widely by industry and should be compared against sector peers. Perishable goods industries target single-digit DSI, while luxury goods or heavy equipment may have DSI exceeding 100 days. Improving DSI involves better demand forecasting, tighter purchasing discipline, faster inbound logistics, and proactive management of slow-moving kayd. Tracking DSI trends over time reveals whether inventory management is improving or deteriorating."
      }
    ],
    "keyTakeaways": [
  ...
  "what-is-perpetual-inventory-system": {
    ...
    "description": "Discover how a perpetual inventory system tracks kayd in real time, updating inventory records continuously with every purchase, sale, and adjustment.",
    "keywords": [
      ...
      "barcode scanning",
      "inventory accuracy",
      "kayd management system"
    ],
    "content": [
      {
        "heading": "What a Perpetual Inventory System Is",
        "body": "A perpetual inventory system continuously updates inventory records as goods are bought, sold, returned, or adjusted. Unlike periodic systems that only determine inventory levels through physical counts at set intervals, perpetual systems maintain a running balance that reflects current kayd at any moment. Every transaction, whether a sale at the point of register, a receiving dock delivery, or a warehouse transfer, immediately updates the system's inventory records."
      },
      {
        "heading": "How Perpetual Systems Work",
        "body": "When goods arrive, they are scanned into the system, increasing the inventory count and recording the cost. When items are sold, the point-of-sale system deducts them from inventory and records the cost of goods sold. Barcode scanners, RFID tags, and integrated enterprise resource planning (ERP) systems automate these transactions. The system maintains both quantity and cost data, enabling real-time reporting on kayd levels, valuation, and margins across all locations."
      },
      {
        "heading": "Advantages Over Periodic Systems",
        "body": "Perpetual systems provide real-time visibility that periodic systems cannot match. Managers can check kayd levels instantly without waiting for physical counts. The system enables automatic reorder point alerts, reduces the risk of stockouts and overstock, and supports accurate financial reporting at any point. Shrinkage and discrepancies are identified faster because the system continuously compares expected versus actual inventory. African retailers adopting cloud-based POS (nidaamka POS) systems are increasingly moving to perpetual tracking."
      },
      {
        "heading": "Implementation Considerations",
        "body": "Implementing a perpetual system requires investment in hardware like barcode scanners, software for inventory management, and shaqaale training. Data accuracy is critical because the system is only as reliable as the transactions recorded. Regular cycle counts, where portions of inventory are physically verified on a rotating schedule, help maintain accuracy. For businesses with multiple locations or warehouses, integrated systems ensure consistency across the entire operation."
      }
    ],
    "keyTakeaways": [
      "A perpetual inventory system updates kayd records in real time as transactions occur.",
      "It provides continuous visibility into inventory levels, cost of goods sold, and kayd valuation.",
    ...
    "faq": [
      {
        ...
        "a": "A perpetual system updates inventory records continuously with each transaction, providing real-time kayd visibility. A periodic system only determines inventory levels through physical counts at set intervals, such as monthly or quarterly, with no real-time tracking between counts."
      },
      {
      ...
      },
      {
        ...
        "a": "Yes, increasingly so. Cloud-based inventory management tools and affordable POS (nidaamka POS) systems with built-in inventory tracking have made perpetual systems accessible to small businesses. Many solutions charge monthly subscription fees rather than requiring large upfront technology investments."
      }
    ]
  },
  "what-is-a-warehouse-management-system": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Implementation timelines range from 2-4 weeks for simple cloud solutions to 6-12 months for enterprise deployments. Key factors include the complexity of warehouse operations, integration requirements with other systems, data migration needs, and the extent of shaqaale training required."
      }
    ]
  },
