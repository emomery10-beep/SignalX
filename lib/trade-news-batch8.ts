...
export const TRADE_NEWS_BATCH_8: BlogPost[] = [
  {
    slug: "inventory-carrying-cost-batch-8-01",
  ...
  {
    slug: "reverse-logistics-returns-batch-8-02",
  ...
  {
    slug: "freight-audit-payment-batch-8-03",
  ...
  {
    slug: "cross-border-ecommerce-logistics-batch-8-04",
  ...
  {
    slug: "sustainable-supply-chain-batch-8-05",
  ...
  {
    slug: "trade-lane-risk-assessment-batch-8-06",
  ...
  {
    slug: "multimodal-transport-optimization-batch-8-07",
  ...
  {
    slug: "customs-brokerage-management-batch-8-08",
  ...
  {
    slug: "supplier-financial-health-batch-8-09",
  ...
  {
    slug: "inventory-visibility-supply-chain-batch-8-10",
