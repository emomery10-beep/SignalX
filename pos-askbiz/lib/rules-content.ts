  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        body: "AskBiz uses Llama by Meta (via Groq) — a general-purpose AI model subject to the GPAI provisions of the AI Act (Chapter V). Our compliance approach:\n\n- We use Llama via Groq's API. Meta, as the GPAI model developer, and Groq, as the infrastructure provider, bear primary obligations under Article 53 for systemic-risk models.\n- AskBiz, as a deployer under Article 26, maintains a post-market monitoring system, provides transparency to users, and cooperates with Groq on compliance.\n- We have contractual commitments from Groq confirming their AI Act compliance obligations.\n- We conduct annual reviews of our AI system deployment against updated EU guidance.",
      },
      {
