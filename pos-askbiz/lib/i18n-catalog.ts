...
// Legal namespaces — en-only; HUMAN legal translation per jurisdiction (excluded
// from the MT pipeline via HUMAN_ONLY in scripts/i18n-translate.mjs).
