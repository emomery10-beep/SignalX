  ...
  if (stage === 'hub') return (
    <div style={{ minHeight: '100vh', background: 'var(--pos-bg)', color: 'var(--pos-ink)', fontFamily: 'system-ui, sans-serif', paddingBottom: 40 }}>
      ...
      {/* Account bar — language + sign out, same slim row on every factory screen.
          Only on the 'hub' stage of this multi-stage page — the start_viewfinder/
          shift_name/end_viewfinder/submitting/start_success/end_success stages
          are a fast camera-driven task flow; their back buttons return here. */}
