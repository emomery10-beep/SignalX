 ...
 * If still pending, verifies directly with payment provider as a webhook fallback.
 */
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Still pending — verify directly with Stripe as webhook fallback
    if (payment.external_reference && payment.provider === 'stripe') {
      try {
