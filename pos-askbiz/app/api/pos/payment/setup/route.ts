    ...
    if (country === 'KE') {
      ...
      try {
        const subaccount = await createSubAccount({
          business_name,
          settlement_bank: '999', // Safaricom (M-Pesa) — check Paystack bank codes
      ...
      // International → Stripe Connect (Phase 2)
      paymentProvider = 'stripe'
      // TODO: Generate Stripe onboarding link when Phase 2 is built
      onboardingUrl = null
    }
