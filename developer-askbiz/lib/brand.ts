// AskBiz brand mark — mirrors the root askbiz.co app's lib/brand.ts (separate
// deployment, can't import across apps, so this is a deliberate copy, not
// drift — keep both in sync if the mark ever changes).
//
