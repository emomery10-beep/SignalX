...
const UPDATED: Record<string, string> = {
  '/docs/changelog': '2026-07-19',
  '/docs/terms': '2026-07-19',
  '/docs/privacy': '2026-07-19',
  '/docs/sitemap': '2026-07-19',
  '/docs/guides/organize-keys-with-apps': '2026-07-19',
  '/docs/guides/use-the-api-console': '2026-07-19',
  '/pricing': '2026-07-19',
}
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    '/docs/guides', '/docs/faq', '/docs/changelog', '/docs/terms', '/docs/privacy', '/docs/sitemap',
  ]
