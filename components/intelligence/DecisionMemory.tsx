  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
        <div>
          <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx)' }}>{tc('intel_decisionmemory.heading')}</div>
          <div style={{ fontSize: 12, color: 'var(--tx3)' }}>{tc('intel_decisionmemory.subheading')}</div>
        </div>
        <button
      ...
      {showLog && (
        <div className="animate-scale-in" style={{ padding: '14px', borderRadius: 12, border: '1px solid rgba(99,102,241,.2)', background: 'rgba(99,102,241,.03)', marginBottom: 14 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#6366F1', marginBottom: 10 }}>{tc('intel_decisionmemory.logFormTitle')}</div>
            ...
            return (
              <div key={d.id} className="animate-fade-up" style={{ animationDelay: `${i * 0.05}s`, padding: '12px 14px', borderRadius: 12, border: '1px solid var(--b)', background: 'var(--sf)' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                  <span style={{ fontSize: 11, fontWeight: 600, color: typeColor.color, background: typeColor.bg, borderRadius: 6, padding: '2px 7px', flexShrink: 0, textTransform: 'capitalize', marginTop: 1 }}>
                    {d.decision_type}
                  </span>
