...
import { getPricing, formatCurrency } from '@/lib/geo'
    ...
    <div style={{ background: 'var(--bg)', color: 'var(--tx)', fontFamily: 'var(--font-dm, DM Sans, sans-serif)', overflowX: 'hidden' }}>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '72px 24px 56px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-sora, Sora, sans-serif)', fontSize: 'clamp(32px, 5vw, 56px)', fontWeight: 700, lineHeight: 1.15, letterSpacing: '-.03em', marginBottom: 20 }}>
          ...
          <span style={{ background:'#6366F1', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>explained in plain English.</span>
        </h1>
            ...
            {TESTIMONIALS.map((t, i) => (
              <div key={i} style={{ padding: '22px', borderRadius: 16, border: '1px solid var(--b)', background: 'var(--bg)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{ width: 36, height: 36, borderRadius: '50%', background:'#6366F1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, color: '#fff', flexShrink: 0 }}>{t.avatar}</div>
                  <div>
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(200px,1fr))', gap: 14 }}>
            {(()=>{
              ...
              const [,growth,business] = getPricing(currency)
              return [
                { name: 'Free', price: 'Free', desc: 'Try it out', features: ['10 AI questions/month', '1 file upload', 'Basic analysis'], cta: 'Start free', highlight: false },
                { name: 'Growth', price: formatCurrency(growth, currency)+'/mo', desc: 'For solo business owners', features: ['500 questions/month', '10 file uploads', 'Expansion intelligence', 'Alerts & forecasts', '7-day free trial'], cta: 'Start free trial', highlight: true },
                { name: 'Business', price: formatCurrency(business, currency)+'/mo', desc: 'Early adoption price — locked forever', features: ['2,000 questions/month', 'Unlimited uploads', '5 team members', 'API access'], cta: 'Get Business', highlight: false },
              ]
            })().map((p, i) => (
