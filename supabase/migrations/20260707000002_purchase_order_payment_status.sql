...
-- receipt, not invoice payment). Needed so the Zakat calculator can
-- treat a genuinely-unpaid received order as a real deductible
-- short-term payable, instead of guessing.
--
-- Byte-identical mirror of pos-askbiz's matching migration — both
