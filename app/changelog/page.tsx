...
const buildReleases = (t: (key: string) => string): Release[] => [
  { version: '2.21.0', date: '2026-07-27', summary: t('changelog.rel_17_summary'), changes: [
    { type: 'new',      text: t('changelog.rel_17_change_0') },
    { type: 'new',      text: t('changelog.rel_17_change_1') },
    { type: 'new',      text: t('changelog.rel_17_change_2') },
    { type: 'new',      text: t('changelog.rel_17_change_3') },
    { type: 'new',      text: t('changelog.rel_17_change_4') },
    { type: 'new',      text: t('changelog.rel_17_change_5') },
    { type: 'new',      text: t('changelog.rel_17_change_6') },
    { type: 'new',      text: t('changelog.rel_17_change_7') },
    { type: 'new',      text: t('changelog.rel_17_change_8') },
    { type: 'new',      text: t('changelog.rel_17_change_9') },
    { type: 'new',      text: t('changelog.rel_17_change_10') },
    { type: 'new',      text: t('changelog.rel_17_change_11') },
    { type: 'new',      text: t('changelog.rel_17_change_12') },
    { type: 'improved', text: t('changelog.rel_17_change_13') },
    { type: 'improved', text: t('changelog.rel_17_change_14') },
    { type: 'improved', text: t('changelog.rel_17_change_15') },
    { type: 'improved', text: t('changelog.rel_17_change_16') },
    { type: 'improved', text: t('changelog.rel_17_change_17') },
    { type: 'improved', text: t('changelog.rel_17_change_18') },
    { type: 'improved', text: t('changelog.rel_17_change_19') },
    { type: 'improved', text: t('changelog.rel_17_change_20') },
    { type: 'improved', text: t('changelog.rel_17_change_21') },
    { type: 'improved', text: t('changelog.rel_17_change_22') },
    { type: 'fixed',    text: t('changelog.rel_17_change_23') },
    { type: 'fixed',    text: t('changelog.rel_17_change_24') },
    { type: 'fixed',    text: t('changelog.rel_17_change_25') },
    { type: 'fixed',    text: t('changelog.rel_17_change_26') },
    { type: 'fixed',    text: t('changelog.rel_17_change_27') },
    { type: 'fixed',    text: t('changelog.rel_17_change_28') },
    { type: 'fixed',    text: t('changelog.rel_17_change_29') },
    { type: 'removed',  text: t('changelog.rel_17_change_30') },
    { type: 'removed',  text: t('changelog.rel_17_change_31') },
  ] },
