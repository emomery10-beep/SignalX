...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://askbiz.co',
    title: 'AskBiz — AI Business Intelligence for SME Founders',
    description: 'AskBiz is AI business intelligence + Point of Sale for SME founders. Ask questions in plain English, get answers from your real data. POS from £5/seat/month. Free to start.',
    siteName: 'AskBiz',
  ...
  twitter: {
    ...
    title: 'AskBiz — AI Business Intelligence for SME Founders',
    description: 'AI business intelligence + Point of Sale for SME founders. Ask questions in plain English, get answers from your real data.',
