...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    // Localized homepages — self-canonicalizing hreflang variants of the root
    ...(['es', 'fr', 'de', 'nl', 'ar', 'sw', 'so'] as const).map(l => ({ url: `${base}/${l}`, lastModified: now, changeFrequency: "weekly" as const, priority: 0.9 })),
    ...
    { url: `${base}/free-pos-tanzania`,                          lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/pos-for-market-vendors`,                     lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    // Kenya/Africa category landing pages (sell.ke competitive-gap cluster)
    { url: `${base}/pos-system-kenya`,                           lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/pos-system-africa`,                          lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/best-pos-kenya`,                             lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/retail-pos-kenya`,                           lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/supermarket-pos-kenya`,                      lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/pharmacy-pos-kenya`,                         lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/restaurant-pos-kenya`,                       lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/cloud-pos-kenya`,                            lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/offline-pos-kenya`,                          lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/kra-etims-pos`,                              lastModified: now, changeFrequency: "monthly", priority: 0.9 },
