...
export default function PreviewBilling() {
  ...
  return (
    <div style={{ maxWidth: 680, margin: '40px auto', padding: '0 20px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <h1 style={{ fontSize: 22, fontWeight: 700, marginBottom: 6 }}>Billing Preview</h1>
      <p style={{ fontSize: 13, color: TX3, marginBottom: 28 }}>Preview of M-Pesa payment section (no auth required)</p>
