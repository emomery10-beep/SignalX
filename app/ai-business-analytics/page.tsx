...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'AI Business Analytics for SMEs | AskBiz',
    description: 'AskBiz uses AI to answer your business questions from your own data. Ask about revenue, margins, stock, pricing, and forecasts. Powered by Claude AI. From £19/month.',
    url: 'https://askbiz.co/ai-business-analytics',
    siteName: 'AskBiz',
    type: 'website',
    images: [{ url: 'https://askbiz.co/api/og?title=AI+Business+Analytics+for+SMEs&category=AskBiz', width: 1200, height: 630, alt: 'AI Business Analytics for SMEs — AskBiz' }],
  },
