      ...
      <div style={{ width: '100%', maxWidth: 440, margin: '0 auto', padding: '32px 16px 40px', flex: 1 }}>
        ...
        {(phase === 'pay' || phase === 'redirecting') && (
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 17, color: TX2, lineHeight: 1.6, marginBottom: 8 }}>
              {tc('pos_setup.activate_subtitle')}
            </p>
            <p style={{ fontSize: 15, color: TX3, marginBottom: 28 }}>
            ...
            <div style={{ padding: '28px 20px', borderRadius: 18, background: SF, border: `1.5px solid ${B2}`, marginBottom: 24 }}>
              <div style={{ fontFamily: 'Sora, sans-serif', fontSize: 46, fontWeight: 700, color: TX, letterSpacing: '-.02em', lineHeight: 1 }}>
                {price}
              </div>
              <div style={{ fontSize: 15, color: TX2, marginTop: 10 }}>
                {tc('pos_setup.activate_price_note', { price })}
              </div>
              {seats > 1 && (
                <div style={{ fontSize: 14, color: TX3, marginTop: 6 }}>
        ...
        {phase === 'checking' && (
          <div style={{ textAlign: 'center', paddingTop: 60 }}>
            ...
            <p style={{ fontSize: 18, fontWeight: 600, color: TX }}>{tc('pos_setup.activate_checking')}</p>
          </div>
        )}
        ...
        {phase === 'cancelled' && (
          <div style={{ textAlign: 'center', paddingTop: 40 }}>
            ...
            <p style={{ fontSize: 17, color: TX2, lineHeight: 1.7, marginBottom: 28 }}>
