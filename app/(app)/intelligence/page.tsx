        ...
        {tab === 'sparring' && (
          <div style={{ maxWidth: 640 }}>
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 13, color: 'var(--tx3)', lineHeight: 1.6 }}>Ask AskBiz to challenge your thinking or model a scenario.</div>
            </div>
            ...
            <textarea value={sparringInput} onChange={e => setSparringInput(e.target.value)} onKeyDown={e => { if (e.key === 'Enter' && !e.shiftKey) { e.preventDefault(); askSparring() } }} placeholder="Ask anything about your business strategy..." rows={3} style={{ width: '100%', padding: '12px 14px', borderRadius: 12, border: '1px solid var(--b2)', background: 'var(--sf)', fontSize: 13, fontFamily: 'inherit', color: 'var(--tx)', resize: 'none', outline: 'none', lineHeight: 1.6, boxSizing: 'border-box', marginBottom: 10 }}></textarea>
