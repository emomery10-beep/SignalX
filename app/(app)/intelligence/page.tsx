      ...
      <div style={{ flexShrink: 0, padding: '16px 20px 0', borderBottom: '1px solid var(--b)', background: 'var(--sf)' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12, marginBottom: 14 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: 'var(--font-sora)', fontSize: 18, fontWeight: 700 }}>{tc('intelligence.header_title')}</div>
              <div style={{ fontSize: 13, color: 'var(--tx3)' }}>{tc('intelligence.header_subtitle')}</div>
            </div>
            {criticalCount > 0 && (
              <span style={{ fontSize: 13, fontWeight: 700, color: '#fff', background: '#EF4444', borderRadius: 9999, padding: '2px 8px' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: isMobile ? '16px 16px 24px' : '20px' }}>
        ...
        {tab === 'overview' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 760 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontSize: 20, fontWeight: 800, color: 'var(--tx)', fontFamily: 'var(--font-sora, inherit)', lineHeight: 1.3 }}>
                  {(() => {
              ...
              <div style={{ padding: '16px 18px', borderRadius: 16, border: '1px solid var(--b)', background: 'linear-gradient(180deg, var(--sf) 0%, rgba(99,102,241,.02) 100%)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx)', letterSpacing: '.02em' }}>{tc('intelligence.financial_summary')}</span>
                  </div>
                  <button onClick={() => setTab('cfo')} style={{ fontSize: 13, color: '#6366F1', background: 'transparent', border: 'none', cursor: 'pointer', fontFamily: 'inherit', fontWeight: 600 }}>
                  ...
                  {[
                    ...
                    return (
                      <div key={i} style={{ padding: '10px 12px', borderRadius: 10, background: 'var(--sf)', border: '1px solid var(--b)', textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: 18, fontWeight: 700, color: item.color, fontFamily: 'var(--font-sora, inherit)' }}>{fmtVal}</div>
                      </div>
                    )
                  })}
                </div>
            ...
            {(logisticsHealth || courierSummary) && (
              <div style={{ padding: '16px 18px', borderRadius: 'var(--r-lg)', border: '1px solid var(--b)', background: 'var(--sf)' }}>
                <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--tx)', marginBottom: 14, fontFamily: 'var(--font-dm), sans-serif' }}>
                    ...
                    return (
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 10 }}>
                          ...
                          <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--tx)', fontFamily: 'var(--font-dm), sans-serif' }}>{tc('intelligence.shipments_card_title')}</span>
                          <span style={{ fontSize: 12, fontWeight: 600, padding: '2px 7px', borderRadius: 'var(--r-pill, 9999px)', color: hColor, background: hBg, fontFamily: 'var(--font-dm), sans-serif', marginLeft: 'auto' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 8 }}>
                          ...
                          <span style={{ fontSize: 14, color: 'var(--tx3)', fontFamily: 'var(--font-dm), sans-serif' }}>/100</span>
                        </div>
                        ...
                        <div style={{ fontSize: 13, color: 'var(--tx3)', lineHeight: 1.4, fontFamily: 'var(--font-dm), sans-serif' }}>
                  ...
                  {courierSummary && courierSummary.total > 0 && (
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 10 }}>
                        ...
                        <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--tx)', fontFamily: 'var(--font-dm), sans-serif' }}>{tc('intelligence.courier_card_title')}</span>
                        {courierSummary.stuck > 0 && (
                          <span style={{ fontSize: 12, fontWeight: 600, padding: '2px 7px', borderRadius: 'var(--r-pill, 9999px)', color: '#dc2626', background: 'rgba(239,68,68,.08)', fontFamily: 'var(--font-dm), sans-serif', marginLeft: 'auto' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 8 }}>
                        ...
                        <span style={{ fontSize: 14, color: 'var(--tx3)', fontFamily: 'var(--font-dm), sans-serif' }}>{tc('intelligence.courier_delivery_rate')}</span>
                      </div>
                      <div style={{ height: 3, borderRadius: 'var(--r-pill, 9999px)', background: 'var(--b2)', overflow: 'hidden', marginBottom: 8 }}>
            ...
            {connectedCount < totalSources && connectedCount < 5 && (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--tx)', marginBottom: 2, fontFamily: 'var(--font-dm), sans-serif' }}>
                    {tc('intelligence.connect_more_title')}
                  </div>
                  <div style={{ fontSize: 13, color: 'var(--tx3)', fontFamily: 'var(--font-dm), sans-serif' }}>
                    {tc('intelligence.connect_more_sub', { connected: connectedCount, total: totalSources })}
                  </div>
                </div>
                <span style={{ fontSize: 13, color: 'var(--acc)', fontWeight: 600, whiteSpace: 'nowrap', fontFamily: 'var(--font-dm), sans-serif' }}>{tc('intelligence.connect_cta')}</span>
              </button>
            )}
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx)', letterSpacing: '.02em' }}>{tc('intelligence.analytics_title')}</span>
                </div>
                <span style={{ fontSize: 13, color: 'var(--tx3)' }}>{tc('intelligence.analytics_last_30')}</span>
              </div>
              ...
              {waterfallDrill && (
                <div style={{
                  ...
                  marginTop: 10, fontSize: 13, color: '#6366F1', fontWeight: 500,
              ...
              <div style={{ padding: '16px 18px', borderRadius: 16, border: '1px solid var(--b)', background: 'linear-gradient(180deg, var(--sf) 0%, rgba(239,68,68,.02) 100%)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx)', letterSpacing: '.02em' }}>{tc('intelligence.active_alerts')}</span>
                    <span style={{
                  ...
                  <button
                    onClick={() => router.push('/alerts')}
                    style={{ fontSize: 13, color: '#6366F1', background: 'transparent', border: 'none', cursor: 'pointer', fontFamily: 'inherit', fontWeight: 600 }}
                  >
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                ...
                <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx)', letterSpacing: '.02em' }}>{tc('intelligence.quick_actions')}</span>
              </div>
              ...
              <div className="rgrid-2" style={{ gap: 10, marginBottom: 10 }}>
                {[
                  ...
                  >
                    ...
                    <div>
                      <div style={{ fontSize: 16, fontWeight: 700, color: 'var(--tx)', marginBottom: 3 }}>{card.title}</div>
                      <div style={{ fontSize: 13, color: 'var(--tx3)', lineHeight: 1.4 }}>{card.sub}</div>
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="rgrid-4" style={{ gap: 10 }}>
                {[
                  ...
                  >
                    ...
                    <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx)', marginBottom: 2 }}>{card.title}</div>
                    <div style={{ fontSize: 12, color: 'var(--tx3)' }}>{card.sub}</div>
                  </button>
                ))}
              </div>
            </div>
        ...
        {tab === 'logistics' && (
          <div style={{ maxWidth: 720 }}>
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontFamily: 'var(--font-sora)', fontSize: 20, fontWeight: 700, letterSpacing: '-0.02em', marginBottom: 4, color: 'var(--tx)' }}>{tc('intelligence.logistics_heading')}</div>
              <div style={{ fontSize: 15, color: 'var(--tx3)', lineHeight: 1.55 }}>{tc('intelligence.logistics_sub')}</div>
            </div>
            ...
            {logisticsView === 'outgoing' && (
              <div>
                <div style={{ marginBottom: 14, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
                  <div>
                    <div style={{ fontFamily: 'var(--font-sora)', fontSize: 16, fontWeight: 700, marginBottom: 2, color: 'var(--tx)' }}>{tc('intelligence.shipments_heading')}</div>
                    <div style={{ fontSize: 14, color: 'var(--tx3)' }}>{tc('intelligence.shipments_sub')}</div>
                  </div>
                  <button
                    onClick={() => router.push('/shipments')}
                    style={{ padding: '8px 18px', borderRadius: 'var(--r-pill, 9999px)', border: 'none', background: 'var(--acc)', color: '#fff', fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--font-dm), sans-serif', transition: 'opacity 150ms' }}
                ...
                <div style={{ marginTop: 14, padding: '14px 16px', borderRadius: 'var(--r-md)', background: 'var(--sf)', border: '1px solid var(--b)' }}>
                  <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--tx)', fontFamily: 'var(--font-dm), sans-serif', marginBottom: 10 }}>{tc('intelligence.quick_actions')}</div>
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                    {[
                      ...
                      <button
                        key={i}
                        onClick={item.action}
                        style={{ padding: '7px 14px', borderRadius: 'var(--r-pill, 9999px)', border: '1px solid var(--b2)', background: 'var(--ev)', color: 'var(--tx2)', fontSize: 14, cursor: 'pointer', fontFamily: 'var(--font-dm), sans-serif', transition: 'border-color 150ms, color 150ms' }}
            ...
            {logisticsView === 'incoming' && (
              <div>
                <div style={{ marginBottom: 14 }}>
                  <div style={{ fontFamily: 'var(--font-sora)', fontSize: 16, fontWeight: 700, marginBottom: 2, color: 'var(--tx)' }}>{tc('intelligence.courier_heading')}</div>
                  <div style={{ fontSize: 14, color: 'var(--tx3)' }}>{tc('intelligence.courier_sub')}</div>
                </div>
        ...
        {tab === 'market' && (
          <div style={{ maxWidth: 720 }}>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontFamily: 'var(--font-sora)', fontSize: 18, fontWeight: 700, marginBottom: 3 }}>{tc('intelligence.market_heading')}</div>
              <div style={{ fontSize: 14, color: 'var(--tx3)' }}>{tc('intelligence.market_sub')}</div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, padding: '16px', borderRadius: 14, border: '1px solid var(--b)', background: 'var(--sf)', marginBottom: 20 }}>
              <div style={{ display: 'flex', gap: 8 }}>
                <input
                  ...
                  style={{ flex: 1, padding: '10px 14px', borderRadius: 10, border: '1px solid var(--b)', background: 'var(--bg)', color: 'var(--tx)', fontSize: 16, fontFamily: 'inherit', outline: 'none' }}
                />
                <button
                  onClick={searchMarket}
                  disabled={mktLoading || !mktQuery.trim()}
                  style={{ padding: '10px 20px', borderRadius: 10, border: 'none', background: '#d08a59', color: '#fff', fontSize: 15, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', opacity: mktLoading || !mktQuery.trim() ? 0.5 : 1 }}
                >
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                <input
                  ...
                  style={{ flex: 1, minWidth: 140, padding: '7px 12px', borderRadius: 8, border: '1px solid var(--b)', background: 'var(--bg)', color: 'var(--tx)', fontSize: 15, fontFamily: 'inherit', outline: 'none' }}
                />
                <select
                  value={mktChannel}
            ...
            {mktResult?.locked && (
              <div style={{ padding: '24px 20px', borderRadius: 14, border: '1px solid #d08a59', background: 'rgba(208,138,89,0.07)', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: 17, fontWeight: 700, color: 'var(--tx)', marginBottom: 6 }}>{tc('intelligence.market_locked_title')}</div>
                <div style={{ fontSize: 15, color: 'var(--tx3)', marginBottom: 16, lineHeight: 1.5 }}>{tc('intelligence.market_locked_desc')}</div>
                <a href="/billing" style={{ display: 'inline-block', padding: '10px 24px', borderRadius: 9999, background: '#d08a59', color: '#fff', fontSize: 15, fontWeight: 600, textDecoration: 'none' }}>{tc('intelligence.market_upgrade')}</a>
              </div>
            )}
            {mktResult?.error && (
              <div style={{ padding: '14px 16px', borderRadius: 12, background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', fontSize: 15, color: '#EF4444' }}>{mktResult.error}</div>
            )}
            {mktResult && !mktResult.locked && !mktResult.error && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                {mktResult.catalogue?.length > 0 && (
                  <div style={{ borderRadius: 14, border: '1px solid var(--b)', background: 'var(--sf)', overflow: 'hidden' }}>
                    <div style={{ padding: '12px 16px', borderBottom: '1px solid var(--b)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx3)', textTransform: 'uppercase', letterSpacing: '.08em' }}>{tc('intelligence.market_merchant_data')}</div>
                      <span style={{ fontSize: 13, color: 'var(--tx3)' }}>{tc('intelligence.market_records', { count: mktResult.catalogue.length, plan: mktResult.plan })}</span>
                    </div>
                        ...
                        <thead>
                          <tr style={{ background: 'var(--ev)' }}>
                            {['product','channel','region','avg_price','min','max','margin','merchants'].map(h => (
                              <th key={h} style={{ padding: '8px 12px', textAlign: 'left', fontSize: 13, fontWeight: 600, color: 'var(--tx3)', whiteSpace: 'nowrap' }}>{tc('intelligence.market_col_' + h)}</th>
                            ))}
                          </tr>
                        </thead>
                        <tbody>
                ...
                {mktResult.catalogue?.length === 0 && (
                  <div style={{ padding: '14px 16px', borderRadius: 12, background: 'var(--sf)', border: '1px solid var(--b)', fontSize: 15, color: 'var(--tx3)' }}>
                ...
                {mktResult.routes?.length > 0 && (
                  <div style={{ borderRadius: 14, border: '1px solid var(--b)', background: 'var(--sf)', overflow: 'hidden' }}>
                    <div style={{ padding: '12px 16px', borderBottom: '1px solid var(--b)' }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx3)', textTransform: 'uppercase', letterSpacing: '.08em' }}>{tc('intelligence.market_route_intel', { region: mktResult.region })}</div>
                    </div>
                    <div style={{ overflowX: 'auto' }}>
                      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 15 }}>
                        <thead>
                          <tr style={{ background: 'var(--ev)' }}>
                            {['origin','destination','carrier','transit','ontime','customs','merchants'].map(h => (
                              <th key={h} style={{ padding: '8px 12px', textAlign: 'left', fontSize: 13, fontWeight: 600, color: 'var(--tx3)', whiteSpace: 'nowrap' }}>{tc('intelligence.market_route_' + h)}</th>
                            ))}
                          </tr>
                        </thead>
                        <tbody>
                ...
                {mktResult.web && (
                  <div style={{ borderRadius: 14, border: '1px solid var(--b)', background: 'var(--sf)', overflow: 'hidden' }}>
                    <div style={{ padding: '12px 16px', borderBottom: '1px solid var(--b)' }}>
                      <div style={{ fontSize: 14, fontWeight: 700, color: 'var(--tx3)', textTransform: 'uppercase', letterSpacing: '.08em' }}>{tc('intelligence.market_web_signals')}</div>
                    </div>
                    <div style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 14 }}>
                      {mktResult.web.price_summary && (
                        <div>
                          <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--tx3)', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 6 }}>{tc('intelligence.market_price_summary')}</div>
                          <div style={{ fontSize: 15, color: 'var(--tx)', lineHeight: 1.6, padding: '10px 14px', borderRadius: 10, background: 'var(--ev)' }}>{mktResult.web.price_summary}</div>
                            ...
                            <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 6 }}>
                              {mktResult.web.price_sources.map((s: any, i: number) => (
                                <a key={i} href={s.url} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', flexDirection: 'column', gap: 2, padding: '8px 12px', borderRadius: 8, border: '1px solid var(--b)', textDecoration: 'none' }}>
                                  <span style={{ fontSize: 14, fontWeight: 600, color: '#6366F1' }}>{s.title}</span>
                                  <span style={{ fontSize: 13, color: 'var(--tx3)', lineHeight: 1.5 }}>{s.snippet}</span>
                                </a>
                              ))}
                            </div>
                          )}
                      ...
                      {mktResult.web.news?.length > 0 && (
                        <div>
                          <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--tx3)', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 6 }}>{tc('intelligence.market_news')}</div>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                            {mktResult.web.news.map((n: any, i: number) => (
                              <a key={i} href={n.url} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, padding: '8px 12px', borderRadius: 8, border: '1px solid var(--b)', textDecoration: 'none' }}>
                                <span style={{ fontSize: 14, fontWeight: 500, color: '#6366F1', flex: 1 }}>{n.title}</span>
                                {n.date && <span style={{ fontSize: 13, color: 'var(--tx3)', whiteSpace: 'nowrap' }}>{n.date?.slice(0,10)}</span>}
                              </a>
                            ))}
                          </div>
                        </div>
                ...
                {mktResult.data_thin && (
                  <div style={{ padding: '10px 14px', borderRadius: 10, background: 'rgba(208,138,89,0.08)', border: '1px solid rgba(208,138,89,0.2)', fontSize: 14, color: '#d08a59' }}>
            ...
            {!mktResult && !mktLoading && (
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 10, marginTop: 4 }}>
                {[['leather handbag','USA'],['running shoes','UK'],['phone case','EU'],['candles','']].map(([product, region], i) => (
                  ...
                  >
                    <div style={{ fontSize: 14, color: 'var(--tx3)', marginBottom: 3 }}>{tc('intelligence.market_try_searching')}</div>
                    <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--tx)' }}>{product}{region ? `, ${region}` : ''}</div>
                  </button>
                ))}
              </div>
            )}
