...
export default function DashboardPage() {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', height:'100%', overflowY:'auto', background:'var(--bg)' }}>
      ...
      {/* ── MAIN GRID ──────────────────────────────────────── */}
      <div style={{ padding:'0 24px 24px', display:'grid', gridTemplateColumns:'1fr 300px', gap:16, flex:1, minHeight:0 }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:16, minWidth:0 }}>
          ...
          <div style={{ background:'var(--sf)', border:'1px solid var(--b)', borderRadius:18, padding:'18px 20px' }}>
            ...
            {loading
              ? [1,2].map(i => <div key={i} style={{ height:52, borderRadius:12, background:'var(--ev)', marginBottom:8, animation:'shimmer 1.4s infinite', backgroundSize:'200% 100%' }}/>)
              : insights.map(ins => (
