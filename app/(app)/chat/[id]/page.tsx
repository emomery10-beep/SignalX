        ...
        <div style={{ maxWidth:680, margin:'0 auto', padding:'0 18px', display:'flex', flexDirection:'column', gap:2 }}>
          {isEmpty && (
            <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', minHeight:400, textAlign:'center', padding:28 }}>
              <div style={{ width:50, height:50, borderRadius:14, background:'linear-gradient(135deg,#d08a59,#8c6fe0)', display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 18px' }}>
          ...
          {messages.map(msg => (
            <div key={msg.id} style={{ display:'flex', gap:9, padding:'2px 0', flexDirection:msg.role==='user'?'row-reverse':'row', animation:'msgIn .26s cubic-bezier(.16,1,.3,1) both' }}>
              <div style={{ width:26, height:26, borderRadius:'50%', flexShrink:0, display:'flex', alignItems:'center', justifyContent:'center', fontSize:9, fontWeight:600, marginTop:3, background:msg.role==='assistant'?'linear-gradient(135deg,#d08a59,#8c6fe0)':'var(--ov)', color:msg.role==='assistant'?'#04080f':'var(--tx2)' }}>
                {msg.role==='assistant' ? <svg width="11" height="11" viewBox="0 0 18 18" fill="none" stroke="#04080f" strokeWidth="2.3" strokeLinecap="round"><polyline points="2,14 6,8 10,11 14,4"/></svg> : (user.initials||'U')}
              </div>
          ...
          {isLoading && (
            <div style={{ display:'flex', gap:9, padding:'2px 0' }}>
              <div style={{ width:26, height:26, borderRadius:'50%', background:'linear-gradient(135deg,#d08a59,#8c6fe0)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
