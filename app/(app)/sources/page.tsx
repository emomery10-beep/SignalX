...
const SOURCES: SourceDef[] = [
  ...
  { id: 'jumia',      label: 'Jumia',       category: 'E-Commerce', desc: 'Orders, payouts and stock across your African storefronts', icon: '🛒', accent: '#f68b1e', color: 'rgba(246,139,30,.1)', oauthFlow: false, hint: 'Paste the Client ID + Refresh Token from Jumia Vendor Center › Settings › Applications', fields: [{ key: 'client_id', label: 'Client ID', placeholder: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', type: 'text', required: true }, { key: 'refresh_token', label: 'Refresh Token', placeholder: 'eyJhbGciOi...', type: 'password', required: true }] },
