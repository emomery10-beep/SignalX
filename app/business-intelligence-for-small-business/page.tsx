  ...
  return (
    <SeoPage
      ...
      faqs={[
        ...
        { q: 'How much does AskBiz cost?', a: 'AskBiz has a free plan with 10 questions per month — no credit card required. The Growth plan is £19/month and includes 500 questions, expansion intelligence, alerts, and forecasts. The Business plan is £39/month for unlimited uploads and team access.' },
