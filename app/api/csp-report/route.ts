...
//
// Target of `report-uri` in CONTENT_SECURITY_POLICY_REPORT_ONLY. Its whole job
// is to tell us what the next round of CSP tightening would have broken, on real
// traffic, before any of it is enforced. Read it with:
//
